...
# Link button to external resource
st.button("GoIt looks like there are some errors and issues with the Streamlit code. Below is the corrected version of the code to display the YouTube video and other contents:")
